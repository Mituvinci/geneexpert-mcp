#!/bin/bash
# Download FASTQ files for GSE52778 (Human dexamethasone)
...
echo "Dataset:  GSE52778 (Human dexamethasone)"
...
echo "  bash data/download_new_bulk_RNA_Data/1_GSE52778_pe_clean/1_GSE52778_rename.sh"
