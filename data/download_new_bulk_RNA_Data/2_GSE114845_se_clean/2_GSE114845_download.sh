#!/bin/bash
# Download FASTQ files for GSE114845 (Mouse sleep deprivation SE)
# Usage (run from anywhere in the repo):
#   bash data/download_new_bulk_RNA_Data/2_GSE114845_se_clean/2_GSE114845_download.sh
...
echo "Dataset:  GSE114845 (Mouse sleep deprivation SE)"
...
echo "  bash data/download_new_bulk_RNA_Data/2_GSE114845_se_clean/2_GSE114845_rename.sh"
