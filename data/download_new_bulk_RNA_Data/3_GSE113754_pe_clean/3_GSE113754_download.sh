#!/bin/bash
# Download FASTQ files for GSE113754 (Mouse sleep deprivation PE)
# Usage (run from anywhere in the repo):
#   bash data/download_new_bulk_RNA_Data/3_GSE113754_pe_clean/3_GSE113754_download.sh
...
echo "Dataset:  GSE113754 (Mouse sleep deprivation PE)"
...
echo "  bash data/download_new_bulk_RNA_Data/3_GSE113754_pe_clean/3_GSE113754_rename.sh"
