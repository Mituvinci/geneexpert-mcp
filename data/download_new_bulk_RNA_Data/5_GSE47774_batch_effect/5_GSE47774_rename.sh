#!/bin/bash
# Rename downloaded FASTQs for GSE47774 (SEQC multi-site) (paired-end)
# Usage (run from anywhere in the repo):
#   bash data/download_new_bulk_RNA_Data/5_GSE47774_batch_effect/5_GSE47774_rename.sh

SCRIPT_DIR=$(cd "$(dirname "$0")" && pwd)
cd "$SCRIPT_DIR"

MAP="gsm_map_gse47774.tsv"

echo "Renaming FASTQs for GSE47774 (SEQC multi-site)..."
echo ""
