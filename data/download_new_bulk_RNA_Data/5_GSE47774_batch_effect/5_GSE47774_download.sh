#!/bin/bash
# Download FASTQ files for GSE47774 (SEQC multi-site)
# Usage (run from anywhere in the repo):
#   bash data/download_new_bulk_RNA_Data/5_GSE47774_batch_effect/5_GSE47774_download.sh
...
echo "Dataset:  GSE47774 (SEQC multi-site)"
...
echo "  bash data/download_new_bulk_RNA_Data/5_GSE47774_batch_effect/5_GSE47774_rename.sh"
