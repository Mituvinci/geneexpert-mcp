#!/bin/bash
# Download FASTQ files for E. coli GSE48151 (contamination control)
# Usage (run from anywhere in the repo):
#   bash data/download_new_bulk_RNA_Data/E.coli_GSE48151/E.coli_GSE48151_download.sh
...
echo "Dataset:  E. coli GSE48151 (contamination control)"
...
echo "  bash data/download_new_bulk_RNA_Data/E.coli_GSE48151/E.coli_GSE48151_rename.sh"
